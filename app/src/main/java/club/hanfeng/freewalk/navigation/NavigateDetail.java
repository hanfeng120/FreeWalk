 ...
 */
public class NavigateDetail extends BaseViewGroup implements OnHomeTopBarSelectedListener, LocationSource, AMapLocationListener, AMap.OnMarkerClickListener, AMap.OnInfoWindowClickListener, AMap.OnMapClickListener {
    ...
    public NavigateDetail(Context context) {
        super(context);
    }

    @Override
    public int getRootViewResId() {
        return R.layout.layout_homepage2;
    }
